...
`POST /api/settings` accepts the automation, Comfort Sync, Comfort Pace, Comfort Envelope, fan saver, upstairs comfort, presence, and schedule settings used by the MudBlazor settings page.
